...
// Adding the function to a website

const buttonOne = document.getElementsByClassName('promptbutton')[0];
const buttonTwo = document.getElementsByClassName('promptbutton')[1];
const paragraph = document.getElementById('prompt');

function startPrompt () {
    buttonOne.style.display = 'none';
    buttonTwo.style.display = 'inline-block';
    paragraph.innerHTML = promptGenerator();
}
...
buttonOne.addEventListener('click', startPrompt);
buttonTwo.addEventListener('click', againPrompt);